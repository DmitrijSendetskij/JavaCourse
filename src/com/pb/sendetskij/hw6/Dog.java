...
public class Dog extends Animal{
    ...
    ///////////////////////////////////////////////////////
    public Dog(int age,int weight,String name,String food,String location ){
        super(animal);
        this.age = age;
        this.weight = weight;
        this.name = name;
    ...
    public void makeNoise(){
        System.out.println("Пес "+ name + ": " + getMakeNoise());
    };

    @Override
    public void eat(){
        System.out.println("Пес " + food + " ест: " + getFood());
    };
    @Override
    public String toString(){
        return "Пес: " + name + age +  weight + food + location ;
    }
    @Override
    public int hashCode(){
